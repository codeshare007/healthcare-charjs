module.exports = [
  ...
  },
  {
    ...
    chart_subtitle:
      "Respondents were allowed to select multiple options. Percentage of responses is presented.",
    status: "Functional",
    public_question_number: "",
    value: "Q8",
    category: "1-primary-care",
  ...
  },
  {
    ...
    chart_subtitle:
      "Percentages of people who tried to get care last time they had a health issue and paid a fee. Respondents were allowed to select multiple options. Percentage of responses is presented.",
    status: "Functional",
    public_question_number: "",
    value: "Q22",
    category: "2-no-primary-care",
  ...
  },
  {
    ...
    chart_subtitle:
      "Percentage of people who tried to get care at a walk-in clinic in the last 12 months. Respondents were allowed to select multiple options. Percentage of responses is presented.",
    status: "Functional",
    public_question_number: "",
    value: "Q32",
    category: "4-walk-in-clinics",
  ...
  },
  {
    ...
    updated_label:
      "How willing would you be to use new virtual services if the company that ran the service sold your health data to pharmaceutical or insurance companies after removing information that could identify you?",
    chart_subtitle: "",
    status: "Functional",
    public_question_number: "",
    value: "Q36_4",
  ...
  },
  {
    ...
    chart_subtitle:
      "Percentage of people with family doctor or nurse practitioner. Respondents were allowed to select multiple options. Percentage of responses is presented.",
    status: "Functional",
    public_question_number: "",
    value: "Q123",
    category: "5-virtual-care",
    category2: "",
    include: "Yes",
  },
  {
  ...
  },
  {
    ...
    chart_subtitle:
      "Percentage of people who would not like to get care through phone appointment. Respondents were allowed to select multiple options. Percentage of responses is presented.",
    status: "Functional",
    public_question_number: "",
    value: "Q125",
    category: "5-virtual-care",
  ...
  },
  {
    ...
    chart_subtitle:
      "Percentage of people who would not like to get care through video appointment. Respondents were allowed to select multiple options. Percentage of responses is presented.",
    status: "Functional",
    public_question_number: "",
    value: "Q127",
    category: "5-virtual-care",
